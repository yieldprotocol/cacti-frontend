export default [
  ...
  { anonymous: false, inputs: [], name: 'KeysCleared', type: 'event' },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'max_deposits', type: 'uint256' }],
    name: 'depositEther',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [],
    name: 'frxETHToken',
    outputs: [{ internalType: 'contract frxETH', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'remove_idx', type: 'uint256' },
      {
        internalType: 'bool',
        name: 'dont_care_about_ordering',
        type: 'bool',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'from_idx', type: 'uint256' },
      { internalType: 'uint256', name: 'to_idx', type: 'uint256' },
    ],
    name: 'swapValidator',
    outputs: [],
    stateMutability: 'nonpayable',
