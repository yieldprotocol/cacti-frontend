    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <Button
        onClick={(e) => {
          handleClose();
          spoofBotMessage(
            `Sure, let me swap that wETH into UNI. <|swap('0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984', '100000000000000000')|> Click the above button to make the swap.`
          );
        }}
      >
      ...
      <div className="flex flex-col justify-center text-xs">
        <p>{`<|swap('0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984', '100000000000000000')|>`}</p>
      </div>
      <Button
        onClick={(e) => {
          handleClose();
          spoofBotMessage(
            `Sure, let me swap that ETH into UNI. <|swap('ETH', '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984', '100000000000000000')|> Click the above button to make the swap.`
          );
        }}
      >
      ...
      <div className="flex flex-col justify-center text-xs">
        <p>{`<|swap('ETH', '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984', '100000000000000000')|>`}</p>
      </div>
    </div>
  );
};
