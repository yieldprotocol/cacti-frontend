...
import { composeFromString } from './composer';
...
const ComposerDemo = (props: any) => {
  return (
    <div className="h-full gap">
...
export default meta;
type Story = StoryObj<typeof ComposerDemo>;
