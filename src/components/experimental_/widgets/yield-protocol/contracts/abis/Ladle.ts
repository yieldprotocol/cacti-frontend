export default [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IJoin', name: 'join', type: 'address' },
    ],
    name: 'addJoin',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'bytes12', name: 'vaultId_', type: 'bytes12' },
  ...
  {
    inputs: [{ internalType: 'bytes12', name: 'vaultId_', type: 'bytes12' }],
    name: 'destroy',
    outputs: [],
    stateMutability: 'payable',
    type: 'function',
  },
  {
    ...
    name: 'exitEther',
    outputs: [{ internalType: 'uint256', name: 'ethTransferred', type: 'uint256' }],
    stateMutability: 'payable',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'bytes6', name: 'etherId', type: 'bytes6' }],
    name: 'joinEther',
    outputs: [{ internalType: 'uint256', name: 'ethTransferred', type: 'uint256' }],
    stateMutability: 'payable',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint8', name: 'loan', type: 'uint8' },
      { internalType: 'uint128', name: 'max', type: 'uint128' },
    ],
    name: 'roll',
    outputs: [
      ...
      { internalType: 'uint128', name: 'newDebt', type: 'uint128' },
    ],
    stateMutability: 'payable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      { internalType: 'contract IERC20', name: 'token', type: 'address' },
      { internalType: 'address', name: 'receiver', type: 'address' },
      { internalType: 'uint128', name: 'wad', type: 'uint128' },
    ],
    name: 'transfer',
    outputs: [],
    stateMutability: 'payable',
