...
import Grid from '@/components/legacyUI/Grid';
import {
  NftAssetContainer,
  NftAssetTraitValueContainer,
  NftAssetTraitsContainer,
} from '@/components/legacyUI/widgets/NftAssetContainer';
import {
  NftCollectionAssetsContainer,
  NftCollectionContainer,
  NftCollectionTraitValuesContainer,
  NftCollectionTraitsContainer,
} from '@/components/legacyUI/widgets/NftCollectionContainer';
import { Price } from '@/components/legacyUI/widgets/Price';
import { TransferWidget } from '@/components/legacyUI/widgets/Transfer';
