...
import { NftAssetContainer } from '@/components/legacyUI/widgets/NftAssetContainer';
import { NftCollectionTraitsContainer } from '@/components/legacyUI/widgets/NftCollectionContainer';
