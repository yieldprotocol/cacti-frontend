...
import { MultiStepContainer } from '../legacyUI/widgets/MultiStepContainer';
...
import { Widgetize } from '../legacyUI/MessageTranslator';
...
export const Widget = (props: WidgetProps) => {
  ...
  if (widgets.has(fnName)) {
    ...
    /* Else, 'try' to get the widget from the previous legacy implementation */
    try {
