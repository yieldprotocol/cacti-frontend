  ...
  return (
    <li>
      <a
        ...
        rel="noreferrer"
      >
        <div className="rounded-xl bg-gray-800 shadow-sm">
          <img
            className="h-[160px] min-w-[160px] rounded-xl hover:opacity-60"
            src={previewImageUrl}
            alt=""
          />
        </div>
        <div className="mt-1 flex flex-col items-center justify-center">
          <p className="ml-3 text-xs font-bold text-gray-200 hover:underline">{name}</p>
