...
import { erc20ABI, useAccount, useBalance as useBalanceWagmi, useContractRead } from 'wagmi';
 ...
 * @param address
 */
const useBalance = (address: string | undefined, erc1155TokenId?: string) => {
  ...
  return {
    data: erc1155TokenId ? erc1155Bal : data,
